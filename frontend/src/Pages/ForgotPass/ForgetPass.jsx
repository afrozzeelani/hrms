...
const ForgetPass = () => {
  ...
  const verfyEmail = async () => {
    await axios
      .post(`${window.location.origin}/api/verfy_email`, data)
      .then((res) => {
  ...
  const SendOtp = async () => {
    ...
    await axios
      .post(`${window.location.origin}/api/send_otp/${id}`, data)
      .then((res) => {
        let day = new Date();
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${window.location.origin}/api/verfy_otp`,
        data
      );
    } catch (error) {
  ...
  const validateFormInput = async (event) => {
    ...
    if (data.pass === "") {
      ...
      const id = localStorage.getItem("id");
      await axios
        .post(`${window.location.origin}/api/forgot_pass/${id}`, data)
        .then((res) => {
          console.log(res);
